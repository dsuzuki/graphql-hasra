...
export enum Profiles_Constraint {
  ...
  /** unique or primary key constraint */
  ProfilesProfileIdKey = 'profiles_profile_id_key'
}
...
export type GetUsersQuery = { __typename?: 'query_root', users: Array<{ __typename?: 'users', created_at: any, id: any, name: string }> };
